...
namespace FlutterSDK.Painting.Beveledrectangleborder
{
    internal static class BeveledrectangleborderDefaultClass
    {
    }
    ...
    public class BeveledRectangleBorder : FlutterSDK.Painting.Borders.ShapeBorder
    {
        ...
        private Path _GetPath(FlutterBinding.UI.RRect rrect)
        {
            ...
            double tlRadiusX = Dart.Math.MathDefaultClass.Max(0.0, rrect.TlRadiusX);
            double tlRadiusY = Dart.Math.MathDefaultClass.Max(0.0, rrect.TlRadiusY);
            double trRadiusX = Dart.Math.MathDefaultClass.Max(0.0, rrect.TrRadiusX);
            double trRadiusY = Dart.Math.MathDefaultClass.Max(0.0, rrect.TrRadiusY);
            double blRadiusX = Dart.Math.MathDefaultClass.Max(0.0, rrect.BlRadiusX);
            double blRadiusY = Dart.Math.MathDefaultClass.Max(0.0, rrect.BlRadiusY);
            double brRadiusX = Dart.Math.MathDefaultClass.Max(0.0, rrect.BrRadiusX);
            double brRadiusY = Dart.Math.MathDefaultClass.Max(0.0, rrect.BrRadiusY);
            List<Offset> vertices = new List<Offset>() { new Offset(rrect.Left, Dart.Math.MathDefaultClass.Min(centerLeft.Dy, rrect.Top + tlRadiusY)), new Offset(Dart.Math.MathDefaultClass.Min(centerTop.Dx, rrect.Left + tlRadiusX), rrect.Top), new Offset(Dart.Math.MathDefaultClass.Max(centerTop.Dx, rrect.Right - trRadiusX), rrect.Top), new Offset(rrect.Right, Dart.Math.MathDefaultClass.Min(centerRight.Dy, rrect.Top + trRadiusY)), new Offset(rrect.Right, Dart.Math.MathDefaultClass.Max(centerRight.Dy, rrect.Bottom - brRadiusY)), new Offset(Dart.Math.MathDefaultClass.Max(centerBottom.Dx, rrect.Right - brRadiusX), rrect.Bottom), new Offset(Dart.Math.MathDefaultClass.Min(centerBottom.Dx, rrect.Left + blRadiusX), rrect.Bottom), new Offset(rrect.Left, Dart.Math.MathDefaultClass.Max(centerLeft.Dy, rrect.Bottom - blRadiusY)) };
            return new Path();
