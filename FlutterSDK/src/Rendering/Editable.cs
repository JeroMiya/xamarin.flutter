...
namespace FlutterSDK.Rendering.Editable
{
    ...
    public class RenderEditable : FlutterSDK.Rendering.Box.RenderBox, IRelayoutWhenSystemFontsChangeMixin
    {
        ...
        private void _HandleMovement(FlutterSDK.Services.Keyboardkey.LogicalKeyboardKey key, bool wordModifier = default(bool), bool lineModifier = default(bool), bool shift = default(bool))
        {
            ...
            {
                int result = Dart.Math.MathDefaultClass.Max(extent - 1, 0);
            ...
            {
                int result = Dart.Math.MathDefaultClass.Min(extent + 1, _PlainText.Length);
        ...
        private double _GetMaxScrollExtent(Size contentSize)
        {
            ...
            switch (_ViewportAxis) { case Axis.Horizontal: return Dart.Math.MathDefaultClass.Max(0.0, contentSize.Width - Size.Width); case Axis.Vertical: return Dart.Math.MathDefaultClass.Max(0.0, contentSize.Height - Size.Height); }
            return null;
        }
        ...
        public virtual List<FlutterSDK.Rendering.Editable.TextSelectionPoint> GetEndpointsForSelection(FlutterSDK.Services.Textediting.TextSelection selection)
        {
            ...
            {
                List<Dart.UI.TextBox> boxes = _TextPainter.GetBoxesForSelection(selection);
        ...
        private double _PreferredHeight(double width)
        {
            ...
            _LayoutText(maxWidth: width);
            return Dart.Math.MathDefaultClass.Max(PreferredLineHeight, _TextPainter.Height);
        }
        ...
        public virtual void SelectPositionAt(FlutterBinding.UI.Offset from = default(FlutterBinding.UI.Offset), FlutterBinding.UI.Offset to = default(FlutterBinding.UI.Offset), FlutterSDK.Rendering.Editable.SelectionChangedCause cause = default(FlutterSDK.Rendering.Editable.SelectionChangedCause))
        {
            ...
            if (toPosition != null)
            {
                baseOffset = Dart.Math.MathDefaultClass.Min(fromPosition.Offset, toPosition.Offset);
                extentOffset = Dart.Math.MathDefaultClass.Max(fromPosition.Offset, toPosition.Offset);
            }
        ...
        private void _LayoutText(double minWidth = 0.0, double maxWidth = default(double))
        {
            ...
            double availableMaxWidth = Dart.Math.MathDefaultClass.Max(0.0, maxWidth - _CaretMargin);
            double availableMinWidth = Dart.Math.MathDefaultClass.Min(minWidth, availableMaxWidth);
        ...
        private void _PaintFloatingCaret(Canvas canvas, FlutterBinding.UI.Offset effectiveOffset)
        {
            ...
            {
                sizeAdjustmentX = Dart.UI.UiDefaultClass.LerpDouble(sizeAdjustmentX, 0, _ResetFloatingCursorAnimationValue);
                sizeAdjustmentY = Dart.UI.UiDefaultClass.LerpDouble(sizeAdjustmentY, 0, _ResetFloatingCursorAnimationValue);
            }
        ...
        public virtual Offset CalculateBoundedFloatingCursorOffset(FlutterBinding.UI.Offset rawCursorOffset)
        {
            ...
            double adjustedX = Dart.Math.MathDefaultClass.Min(Dart.Math.MathDefaultClass.Max(currentX, leftBound), rightBound);
            double adjustedY = Dart.Math.MathDefaultClass.Min(Dart.Math.MathDefaultClass.Max(currentY, topBound), bottomBound);
        ...
        private void _PaintSelection(Canvas canvas, FlutterBinding.UI.Offset effectiveOffset)
        {
            ...
            foreach (Dart.UI.TextBox box in _SelectionRects) canvas.DrawRect(box.ToRect().Shift(effectiveOffset), paint);
        }
        ...
        private void _PaintHandleLayers(FlutterSDK.Rendering.@object.PaintingContext context, List<FlutterSDK.Rendering.Editable.TextSelectionPoint> endpoints)
        {
            ...
            context.PushLayer(new LeaderLayer(link: StartHandleLayerLink, offset: startPoint), base.Paint, Dart.UI.UiDefaultClass.Offset.Zero);
            if (endpoints.Count == 2)
            {
                Offset endPoint = endpoints[1].Point;
                endPoint = new Offset(endPoint.Dx.Clamp(0.0, Size.Width) as double, endPoint.Dy.Clamp(0.0, Size.Height) as double);
                context.PushLayer(new LeaderLayer(link: EndHandleLayerLink, offset: endPoint), base.Paint, Dart.UI.UiDefaultClass.Offset.Zero);
            }
        ...
        {
            _LayoutText(minWidth: Constraints.MinWidth, maxWidth: Constraints.MaxWidth);
            if (_HasVisualOverflow) context.PushClipRect(NeedsCompositing, offset, Dart.UI.UiDefaultClass.Offset.Zero & Size, _PaintContents); else _PaintContents(context, offset);
