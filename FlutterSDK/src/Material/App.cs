...
namespace FlutterSDK.Material.App
{
    ...
    public class MaterialApp : FlutterSDK.Widgets.Framework.StatefulWidget
    {
        ...
        public new FlutterSDK.Material.App._MaterialAppState CreateState() { throw new NotImplementedException(); }
    ...
    public class _MaterialAppState : FlutterSDK.Widgets.Framework.State<FlutterSDK.Material.App.MaterialApp>
    {
        ...
        public new void DidUpdateWidget(FlutterSDK.Material.App.MaterialApp oldWidget) { throw new NotImplementedException(); }


        private void _UpdateNavigator() { throw new NotImplementedException(); }


        private FlutterSDK.Animation.Tween.RectTween _CreateRectTween(FlutterBinding.UI.Rect begin, FlutterBinding.UI.Rect end) { throw new NotImplementedException(); }
