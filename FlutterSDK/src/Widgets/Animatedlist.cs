...
namespace FlutterSDK.Widgets.Animatedlist
{
    ...
    public class _ActiveItem : IComparable<FlutterSDK.Widgets.Animatedlist._ActiveItem>
    {
        ...
        public new int CompareTo(FlutterSDK.Widgets.Animatedlist._ActiveItem other) => ItemIndex - other.ItemIndex;
    ...
    public class AnimatedList : FlutterSDK.Widgets.Framework.StatefulWidget
    {
        ...
        /// ```
        /// </Summary>
        public virtual FlutterSDK.Widgets.Animatedlist.AnimatedListState Of(FlutterSDK.Widgets.Framework.BuildContext context, bool nullOk = false)
        {


            AnimatedListState result = context.FindAncestorStateOfType();
            if (nullOk || result != null) return result;
            throw FlutterError.FromParts(new List<DiagnosticsNode>() { new ErrorSummary("AnimatedList.of() called with a context that does not contain an AnimatedList."), new ErrorDescription("No AnimatedList ancestor could be found starting from the context that was passed to AnimatedList.of()."), new ErrorHint("This can happen when the context provided is from the same StatefulWidget that " + "built the AnimatedList. Please see the AnimatedList documentation for examples " + "of how to refer to an AnimatedListState object:" + "  https://api.flutter.dev/flutter/widgets/AnimatedListState-class.html"), context.DescribeElement("The context used was") });
        }




        public new FlutterSDK.Widgets.Animatedlist.AnimatedListState CreateState() => new AnimatedListState();
    ...
    public class AnimatedListState : FlutterSDK.Widgets.Framework.State<FlutterSDK.Widgets.Animatedlist.AnimatedList>, ITickerProviderStateMixin<FlutterSDK.Widgets.Animatedlist.AnimatedList>
    {
        ...
        /// </Summary>
        public virtual void InsertItem(int index, TimeSpan duration = default(TimeSpan))
        {
        ...
        /// </Summary>
        public virtual void RemoveItem(int index, FlutterSDK.Widgets.Animatedlist.AnimatedListRemovedItemBuilder builder, TimeSpan duration = default(TimeSpan))
        {
        ...
        {
            return new CustomScrollView(scrollDirection: Widget.ScrollDirection, reverse: Widget.Reverse, controller: Widget.Controller, primary: Widget.Primary, physics: Widget.Physics, shrinkWrap: Widget.ShrinkWrap, slivers: new List<Widget>() { new SliverPadding(padding: Widget.Padding ?? EdgeInsets.All(0), sliver: new SliverAnimatedList(key: _SliverAnimatedListKey, itemBuilder: Widget.ItemBuilder, initialItemCount: Widget.InitialItemCount)) });
        }
    ...
    public class SliverAnimatedList : FlutterSDK.Widgets.Framework.StatefulWidget
    {
        ...
        /// ```
        /// </Summary>
        public virtual FlutterSDK.Widgets.Animatedlist.SliverAnimatedListState Of(FlutterSDK.Widgets.Framework.BuildContext context, bool nullOk = false)
        {
    ...
    public class SliverAnimatedListState : FlutterSDK.Widgets.Framework.State<FlutterSDK.Widgets.Animatedlist.SliverAnimatedList>, ITickerProviderStateMixin<FlutterSDK.Widgets.Framework.StatefulWidget>
    {
        ...
        {
            foreach (_ActiveItem item in _IncomingItems.FollowedBy(_OutgoingItems))
            {
        ...
        private FlutterSDK.Widgets.Animatedlist._ActiveItem _RemoveActiveItemAt(List<FlutterSDK.Widgets.Animatedlist._ActiveItem> items, int itemIndex)
        {
            int i = CollectionsDefaultClass.BinarySearch(items, _ActiveItem.Index(itemIndex));
        ...
        private FlutterSDK.Widgets.Animatedlist._ActiveItem _ActiveItemAt(List<FlutterSDK.Widgets.Animatedlist._ActiveItem> items, int itemIndex)
        {
            int i = CollectionsDefaultClass.BinarySearch(items, _ActiveItem.Index(itemIndex));
        ...
        private int _IndexToItemIndex(int index)
        {
            int itemIndex = index;
        ...
        private int _ItemIndexToIndex(int itemIndex)
        {
            int index = itemIndex;
            foreach (_ActiveItem item in _OutgoingItems)
            {
        ...
        private FlutterSDK.Widgets.Sliver.SliverChildDelegate _CreateDelegate()
        {
        ...
        public virtual void InsertItem(int index, TimeSpan duration = default(TimeSpan))
        {
            ...
            AnimationController controller = new AnimationController(duration: duration, vsync: this);
        ...
        public virtual void RemoveItem(int index, FlutterSDK.Widgets.Animatedlist.AnimatedListRemovedItemBuilder builder, TimeSpan duration = default(TimeSpan))
        {
            ...
            AnimationController controller = incomingItem?.Controller ?? new AnimationController(duration: duration, value: 1.0, vsync: this);
        ...
        private FlutterSDK.Widgets.Framework.Widget _ItemBuilder(FlutterSDK.Widgets.Framework.BuildContext context, int itemIndex)
        {
            ...
            Animation<double> animation = incomingItem?.Controller?.View ?? AnimationsDefaultClass.KAlwaysCompleteAnimation;
