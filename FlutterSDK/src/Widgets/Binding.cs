    ...
    public class WidgetsBinding
    {
        ...
        public new void InitServiceExtensions()
        {
            ...
            if (!ConstantsDefaultClass.KReleaseMode)
            {
                ...
                RegisterServiceExtension(name: "didSendFirstFrameEvent", callback: (_) => async {
                    return new Dictionary<string, object> { { "enabled", _NeedToReportFirstFrame ? "false" : "true" } };
                }
);
                RegisterServiceExtension(name: "didSendFirstFrameRasterizedEvent", callback: (_) => async {
                    return new Dictionary<string, object> { { "enabled", FirstFrameRasterized ? "true" : "false" } };
                }
);
                RegisterServiceExtension(name: "fastReassemble", callback: (Dictionary<string, object> params) => async {
                ...
                RegisterBoolServiceExtension(name: "profileWidgetBuilds", getter: () => async => DebugDefaultClass.DebugProfileBuildsEnabled, setter: (bool value) => async {
